...
class Staffs extends CI_Controller{
    ...
    */
    ...
    public function add(){
        ...
        $this->form_validation->set_rules('mobile', 'Phone number', ['required', 'trim', 'numeric', 'max_length[15]', 'min_length[11]'], 'is_unique[staffs.mobile]'],
                ['required'=>"required", 'is_unique'=>"This number is already attached to an staff"]);
