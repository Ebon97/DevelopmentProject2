...
class Item extends CI_Model{
    ...
    */
    ...
    public function incrementItem($itemId, $numberToadd){
        $q = "UPDATE products SET quantity = quantity + ? WHERE id = ?";
   ...
   public function newstock($itemId, $qty){
       $q = "UPDATE products SET quantity = quantity + $qty WHERE id = ?";
    ...
    */
	...
	public function getActiveProducts($orderBy, $orderFormat){
        $this->db->order_by($orderBy, $orderFormat);
    ...
    */
    ...
    public function getProductsCumTotal(){
